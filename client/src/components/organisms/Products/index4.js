...
import Index4_button from "./index4_button";
...
const Index4 = () => {
  ...
  return (
    <div className="container">
      <div className="container mx-auto bg-white rounded-lg shadow-md mt-4">
        <h3 className="py-4 font-medium text-lg p-4"> Gợi ý hôm nay</h3>
        <Index4_button />
      </div>
      <div className="container mx-auto p-4 bg-white rounded-lg shadow-md mt-2"> 
